  ...
  const tourSteps: TourStep[] = [
    {
      ...
      content:
        'Coshot helps you create beautiful, shareable code screenshots with syntax highlighting and real TypeScript type checking.',
    },
    {
      target: '.editor-container',
      title: 'Code Editor',
      content:
        'Type or paste your code here. The editor provides syntax highlighting for over 100 programming languages, making your code look clean and professional.',
      position: 'top',
    },
    {
      ...
      content:
        "Click the palette icon to choose from over 60 beautiful themes including GitHub, Dracula, One Dark Pro, and more. Each theme instantly updates your code's appearance to match your brand or preference.",
      position: 'bottom',
    },
    {
      target: '.editor-toolbar',
      ...
      content:
        'Select your programming language from 100+ supported languages. Each language gets proper syntax highlighting tailored to its syntax.',
      position: 'bottom',
    },
    {
      target: '.editor-toolbar',
      ...
      content:
        'For TypeScript and JavaScript, enable TwoSlash to show real type information in your screenshots. This feature runs the TypeScript compiler to display actual types and errors.',
      position: 'bottom',
    },
    {
      target: '.editor-container',
      ...
      content:
        'With TwoSlash enabled, try typing: const num = 42; then on the next line type: num and add a comment "//    ^?" to see the type displayed. Perfect for educational content and documentation!',
      position: 'top',
    },
    {
      title: 'Ready to Create!',
      content:
        "You're all set! Create beautiful code screenshots and share them with the Share button. Perfect for documentation, tutorials, and social media.",
    },
  ];
  ...
  return (
    <Show when={props.isOpen}>
      <div class="fixed inset-0 z-2000">
        ...
        {currentStepData()?.target && <div class="highlight-overlay" />}
        ...
        >
          <div class="p-20px">
            ...
            <p class="m-0 mb-20px text-14px">{currentStepData().content}</p>
            ...
            <div class="flex justify-between items-center">
              ...
              <div class="flex gap-8px">
                ...
                <button
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.backgroundColor =
                      colors()?.['button.hoverBackground'] || 'var(--theme-button-hoverBackground)';
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.backgroundColor =
                      colors()?.['button.background'] || 'var(--theme-button-background)';
                    ...
                    'background-color':
                      index === currentStep()
                        ...
                        : colors()?.['scrollbarSlider.background'] ||
                          'var(--theme-scrollbarSlider-background)',
