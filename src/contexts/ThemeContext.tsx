import { createContext, useContext, type Component, type JSX, createEffect, createSignal, onMount } from 'solid-js';
...
const VALID_THEMES: BundledTheme[] = [
  'github-dark', 'github-light', 'andromeeda', 'aurora-x', 'ayu-dark', 'catppuccin-frappe',
  'catppuccin-macchiato', 'catppuccin-mocha', 'catppuccin-latte', 'dark-plus',
  'dracula', 'dracula-soft', 'everforest-dark', 'everforest-light',
  ...
  'kanagawa-wave', 'kanagawa-lotus', 'laserwave', 'light-plus', 'material-theme',
  'material-theme-darker', 'material-theme-ocean', 'material-theme-palenight',
  'material-theme-lighter', 'min-dark', 'min-light', 'monokai', 'night-owl',
  'nord', 'one-dark-pro', 'one-light', 'plastic', 'poimandres', 'red',
  'rose-pine', 'rose-pine-dawn', 'rose-pine-moon', 'slack-dark', 'slack-ochin',
  'snazzy-light', 'solarized-dark', 'solarized-light', 'synthwave-84',
