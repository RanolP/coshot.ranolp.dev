...
export async function getThemeColors(theme: BundledTheme): Promise<ThemeColors> {
  ...
  try {
    ...
    const themeColors: ThemeColors = {
      'editor.background':
        colors['editor.background'] || themeData.bg || defaults['editor.background'],
      'editor.foreground':
        colors['editor.foreground'] || themeData.fg || defaults['editor.foreground'],
      'editor.lineHighlightBackground':
        colors['editor.lineHighlightBackground'] || defaults['editor.lineHighlightBackground'],
      'editor.selectionBackground':
        colors['editor.selectionBackground'] || defaults['editor.selectionBackground'],
      'editor.inactiveSelectionBackground':
        colors['editor.inactiveSelectionBackground'] ||
        defaults['editor.inactiveSelectionBackground'],

      'activityBar.background':
        colors['activityBar.background'] ||
        colors['sideBar.background'] ||
        defaults['activityBar.background'],
      'activityBar.foreground':
        colors['activityBar.foreground'] ||
        colors['sideBar.foreground'] ||
        defaults['activityBar.foreground'],
      'activityBar.border':
        colors['activityBar.border'] || colors['panel.border'] || defaults['activityBar.border'],
      ...
      'sideBar.border':
        colors['sideBar.border'] || colors['panel.border'] || defaults['sideBar.border'],

      'titleBar.activeBackground':
        colors['titleBar.activeBackground'] ||
        colors['activityBar.background'] ||
        defaults['titleBar.activeBackground'],
      'titleBar.activeForeground':
        colors['titleBar.activeForeground'] ||
        colors['activityBar.foreground'] ||
        defaults['titleBar.activeForeground'],
      'titleBar.border':
        colors['titleBar.border'] || colors['panel.border'] || defaults['titleBar.border'],

      'statusBar.background':
        colors['statusBar.background'] ||
        colors['activityBar.background'] ||
        defaults['statusBar.background'],
      'statusBar.foreground':
        colors['statusBar.foreground'] ||
        colors['activityBar.foreground'] ||
        defaults['statusBar.foreground'],
      'statusBar.border':
        colors['statusBar.border'] || colors['panel.border'] || defaults['statusBar.border'],

      'panel.background':
        colors['panel.background'] || colors['editor.background'] || defaults['panel.background'],
      'panel.border':
        colors['panel.border'] || colors['editorGroup.border'] || defaults['panel.border'],

      'input.background': colors['input.background'] || defaults['input.background'],
      'input.foreground':
        colors['input.foreground'] || colors['editor.foreground'] || defaults['input.foreground'],
      'input.border': colors['input.border'] || defaults['input.border'],
      'input.placeholderForeground':
        colors['input.placeholderForeground'] || defaults['input.placeholderForeground'],
      ...
      'button.hoverBackground':
        colors['button.hoverBackground'] || defaults['button.hoverBackground'],
      ...
      'dropdown.border':
        colors['dropdown.border'] || colors['input.border'] || defaults['dropdown.border'],

      'list.hoverBackground':
        colors['list.hoverBackground'] ||
        colors['editor.hoverHighlightBackground'] ||
      ...
      'list.activeSelectionForeground':
        ...
        colors['editor.selectionForeground'] ||
        colors['editor.foreground'] ||
        defaults['list.activeSelectionForeground'],
      'list.inactiveSelectionBackground':
        colors['list.inactiveSelectionBackground'] ||
        colors['editor.inactiveSelectionBackground'] ||
        defaults['list.inactiveSelectionBackground'],
      'list.inactiveSelectionForeground':
        colors['list.inactiveSelectionForeground'] ||
        colors['editor.foreground'] ||
        defaults['list.inactiveSelectionForeground'],

      'scrollbarSlider.background':
        colors['scrollbarSlider.background'] || defaults['scrollbarSlider.background'],
      'scrollbarSlider.hoverBackground':
        colors['scrollbarSlider.hoverBackground'] || defaults['scrollbarSlider.hoverBackground'],
      'scrollbarSlider.activeBackground':
        colors['scrollbarSlider.activeBackground'] || defaults['scrollbarSlider.activeBackground'],
      ...
      'tooltip.background':
        ...
        defaults['tooltip.background'],
      'tooltip.foreground':
        colors['tooltip.foreground'] ||
        colors['editor.foreground'] ||
        defaults['tooltip.foreground'],
      'tooltip.border':
        colors['tooltip.border'] || colors['panel.border'] || defaults['tooltip.border'],
    };
